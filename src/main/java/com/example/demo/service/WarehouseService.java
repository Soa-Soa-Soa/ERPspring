...
public class WarehouseService {
    ...
    public List<Warehouse> get(String sid) throws Exception{
        ...
        requestBody.put("fields", List.of("name"));
        ...
        List<Warehouse> deviss = new ArrayList<>();
        try {
            ...
            if (message instanceof Map) {
                ...
                deviss = values.stream().map(value -> {
                    ...
                    item.setName((String) value.get(0));
                    return item;
                }).toList();
            }
